extern const int  nqh, npsi, nnad, nnadc, npyr, nsuc, nfum, nfumc, noaa, noaac, ncit, nakgm, nakgc, nglum, nglu, ngluo, naspm, naspc, nca, nc1ros, nc2ros, nc3ros, nk_i, npsio, nNa_i, nAdp, nAtp, neo, nei, nlac, numx;
extern int kmax,kount,ifn,istor,nrhs;
extern const int  NN, qp_FS, rqp_FS, FS_c1, rFS_c1, qp_bl, rqp_bl, bl_bh, rbl_bh, bh_qn1, rbh_qn1, bh_qn2, rbh_qn2, qHbnd, rqHbnd, qnbnd, rqnbnd, qpdis, rqpdis, qhnds,rqhnds, vc1c, bypas, vros, vfadf, vfadr, vbq1, vrbq1, vbq2, vrbq2, vqdis, vrqdis, vqbind, vrqbind, vfred, vrfred, vn56, vrn56, vn2qn1, vrn2qn1, vn2qn2, vrn2qn2, vndis, vrndis, vpbind, vrpbind, ptp, vlk, vatsyn, vtca, vmdh, vK, akgsuc, vglu_akg, vatpase, vglu_tr, vlacdif, vgluout, vcs, vasp_atf, vasp_atr, vGl, vldh, vmalakg, vgluasp, vgluOH, vperos, rct, ntmax, katase, vmdhc, glu_o, laco, k_o, Na_o, nNV;
...
void init_ydot(double *y,int ipar,double dp,double*,double*,const int n);
void ydot(double *y,int ipar,double dp,double*,double*,const int n);
