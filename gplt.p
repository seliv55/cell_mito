...
set ylabel "ROS in CII (nmol/g)" offset 2;
plot fn2 using ($1):rosc2 w l ls 3 t"glu", "rot1" using ($1):rosc2 w l ls 1 t"GLU", fn1 using ($1):rosc2 w l ls 2 t"work";
set ytics autofreq 0.1
set yrange [-0.05 to *]
set label 1 "B" at graph 0.05,1.0 font "arial,12"
set ylabel "ROS in CIII (nmol/g)" offset 2;
